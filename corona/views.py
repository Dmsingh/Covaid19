...
def graph(request):
    ...
    def global_data():
        import requests
        l1,l2,lst=["cases","todayCases","deaths","todayDeaths","recovered","affectedCountries"],[],[]
...
def contact(request):
         ...
         if email==" " and name==" " and query==" " and suggest==" " and myth==" ": 
            ...
            if len(name)>=3 and name[0].isupper()==True and (query)=="" or len(query)>=5 and (suggest)=="" or len(suggest)>=5 and myth=="" or len(myth)>=5 :
                    print("hello")
                    message1=('This data is coming from user end',li,settings.EMAIL_HOST_USER,['pandeysharad52@gmail.com','dm.singh723dm@gmail.com','awnish.singh723dm@gmail.com'],)
                    message2 = ('Check mail from covaidwarriors.com',text,settings.EMAIL_HOST_USER, [email])
                    
                    send_mass_mail((message1, message2), fail_silently=False)
                    
                    print(message1,message2)
                    messages.success(request," BOOYAH! Your data has been submitted successfully.Soon we will contact you at your given email id.")
            else :
                        messages.error(request,"Please fill the field correctly.Hover each field to see the format of a field.")
...
def helpline(request):
            lis=[
            ['Andhra Pradesh', 0, 'file0'],['Arunachal Pradesh', 1, 'file1'],['Assam', 2, 'file2'],['Bihar', 3, 'file3'],['Chhattisgarh', 4, 'file4'],['Goa', 5, 'file5'],
            ['Gujarat', 6, 'file6'],['Haryana', 7, 'file7'],['Himachal Pradesh', 8, 'file8'],['Jharkhand', 9, 'file9'],['Karnataka', 10, 'file10'],['Kerala', 11, 'file11'],
            ['Madhya Pradesh', 12, 'file12'],['Maharashtra', 13, 'file13'],['Manipur', 14, 'file14'],['Meghalaya', 15, 'file15'],['Mizoram', 16, 'file16'],['Nagaland', 17, 'file17'],
            ['Odisha', 18, 'file18'],['Punjab', 19, 'file19'],['Sikkim', 20, 'file20'],['Tamil Nadu', 21, 'file21'],['Telangana', 22, 'file22'],['Tripura', 23, 'file23'],
            ['Uttar Pradesh', 24, 'file24'], ['Uttarakhand', 25, 'file25'],['West Bengal', 26, 'file26'],['Andaman and Nicobar Islands', 27, 'file27'], ['Chandigarh', 28, 'chandigarh'],
            ['Daman and Diu', 29, 'file29'],['Dadra and Nagar Haveli', 30, 'file30'], ['Delhi', 31, 'file31'],['Jammu & kashmir', 32, 'file32'],['Ladakh', 33, 'file33'],
            ['Lakshadweep', 34, 'file34'],['Pondicherry', 35, 'pondicherry' ]]
            print(lis)
...
def country_graph(request):  
    ...
    def country_data(cnt):
            cntry=str(cnt).lower()
            import requests
            l1=["cases","todayCases","deaths","todayDeaths","recovered","active"]
            l2=[]
            l=0
            ...
            if l==0:
                print(l)
                messages.warning(request,"Please enter correct spelling.Given data is incorrect")
